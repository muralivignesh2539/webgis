...
var format_TKBMBOUND_3 = new ol.format.GeoJSON();
var features_TKBMBOUND_3 = format_TKBMBOUND_3.readFeatures(json_TKBMBOUND_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_TKBMBOUND_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_TKBMBOUND_3.addFeatures(features_TKBMBOUND_3);
var lyr_TKBMBOUND_3 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_TKBMBOUND_3, 
                style: style_TKBMBOUND_3,
                popuplayertitle: 'TKBMBOUND',
                interactive: true,
    title: 'TKBMBOUND<br />\
    <img src="styles/legend/TKBMBOUND_3_0.png" /> AMMAYARNADA<br />\
    <img src="styles/legend/TKBMBOUND_3_1.png" /> AZHAKATHU<br />\
    <img src="styles/legend/TKBMBOUND_3_2.png" /> DALAVAPURAM<br />\
    <img src="styles/legend/TKBMBOUND_3_3.png" /> DESAKKALLU<br />\
    <img src="styles/legend/TKBMBOUND_3_4.png" /> GUHANANDAPURAM<br />\
    <img src="styles/legend/TKBMBOUND_3_5.png" /> KUDAVOOR<br />\
    <img src="styles/legend/TKBMBOUND_3_6.png" /> MUTTATHU<br />\
    <img src="styles/legend/TKBMBOUND_3_7.png" /> NADAKKAVU<br />\
    <img src="styles/legend/TKBMBOUND_3_8.png" /> NJARAMMOODU<br />\
    <img src="styles/legend/TKBMBOUND_3_9.png" /> PALLIKKODI<br />\
    <img src="styles/legend/TKBMBOUND_3_10.png" /> PANAVILA<br />\
    <img src="styles/legend/TKBMBOUND_3_11.png" /> THEKKUMVILA<br />\
    <img src="styles/legend/TKBMBOUND_3_12.png" /> UDAYADITHYAPURAM<br />\
    <img src="styles/legend/TKBMBOUND_3_13.png" /> VADAKKEVILA<br />' });
var lyr_LULC_4 = new ol.layer.Image({
        opacity: 1,
        
    title: 'LULC<br />\
    <img src="styles/legend/LULC_4_0.png" /> WATER<br />\
    <img src="styles/legend/LULC_4_1.png" /> VEGETATION<br />\
    <img src="styles/legend/LULC_4_2.png" /> AGRICULTURE<br />\
    <img src="styles/legend/LULC_4_3.png" /> BUILT-UP/BARREN<br />' ,
...
var format_LIESUREPOINTS_5 = new ol.format.GeoJSON();
var features_LIESUREPOINTS_5 = format_LIESUREPOINTS_5.readFeatures(json_LIESUREPOINTS_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_LIESUREPOINTS_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_LIESUREPOINTS_5.addFeatures(features_LIESUREPOINTS_5);
var lyr_LIESUREPOINTS_5 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_LIESUREPOINTS_5, 
                style: style_LIESUREPOINTS_5,
                popuplayertitle: 'LIESUREPOINTS',
                interactive: true,
    title: 'LIESUREPOINTS<br />\
    <img src="styles/legend/LIESUREPOINTS_5_0.png" /> fitness_centre<br />\
    <img src="styles/legend/LIESUREPOINTS_5_1.png" /> playground<br />\
    <img src="styles/legend/LIESUREPOINTS_5_2.png" /> resort<br />\
    <img src="styles/legend/LIESUREPOINTS_5_3.png" /> swimming_pool<br />' });
...
lyr_OpenTopoMap_0.setVisible(true);lyr_GoogleSatellite_1.setVisible(true);lyr_OSMStandard_2.setVisible(true);lyr_TKBMBOUND_3.setVisible(true);lyr_LULC_4.setVisible(true);lyr_LIESUREPOINTS_5.setVisible(true);lyr_TOURISTPOINTS_6.setVisible(true);lyr_TKBMHOSPITAL_7.setVisible(true);lyr_AMENITYPOINTS_8.setVisible(true);lyr_WETLANDPOINTS_9.setVisible(true);
var layersList = [lyr_OpenTopoMap_0,lyr_GoogleSatellite_1,lyr_OSMStandard_2,lyr_TKBMBOUND_3,lyr_LULC_4,lyr_LIESUREPOINTS_5,lyr_TOURISTPOINTS_6,lyr_TKBMHOSPITAL_7,lyr_AMENITYPOINTS_8,lyr_WETLANDPOINTS_9];
lyr_TKBMBOUND_3.set('fieldAliases', {'gml_parent': 'gml_parent', 'gml_pare_1': 'gml_pare_1', 'gml_id': 'gml_id', 'geom': 'geom', 'District': 'District', 'LSGD': 'LSGD', 'Ward_Name': 'Ward_Name', 'Ward_No': 'Ward_No', 'Lsgd_Type': 'Lsgd_Type', 'Created_Da': 'Created_Da', 'Surveyor': 'Surveyor', 'Mob_No': 'Mob_No', 'Remarks': 'Remarks', '_distLsgd': '_distLsgd', 'OBJECTID': 'OBJECTID', '_result': '_result', '_ulid': '_ulid', '_distLsgd2': '_distLsgd2', 'Population': 'Population', });
lyr_LIESUREPOINTS_5.set('fieldAliases', {'fid': 'fid', 'full_id': 'full_id', 'osm_id': 'osm_id', 'osm_type': 'osm_type', 'leisure': 'leisure', });
...
lyr_TKBMBOUND_3.set('fieldImages', {'gml_parent': 'TextEdit', 'gml_pare_1': 'TextEdit', 'gml_id': 'TextEdit', 'geom': 'TextEdit', 'District': 'TextEdit', 'LSGD': 'TextEdit', 'Ward_Name': 'TextEdit', 'Ward_No': 'TextEdit', 'Lsgd_Type': 'TextEdit', 'Created_Da': 'TextEdit', 'Surveyor': 'TextEdit', 'Mob_No': 'TextEdit', 'Remarks': 'TextEdit', '_distLsgd': 'TextEdit', 'OBJECTID': 'TextEdit', '_result': 'TextEdit', '_ulid': 'TextEdit', '_distLsgd2': 'TextEdit', 'Population': 'TextEdit', });
lyr_LIESUREPOINTS_5.set('fieldImages', {'fid': 'TextEdit', 'full_id': 'TextEdit', 'osm_id': 'TextEdit', 'osm_type': 'TextEdit', 'leisure': 'TextEdit', });
...
lyr_TKBMBOUND_3.set('fieldLabels', {'gml_parent': 'no label', 'gml_pare_1': 'no label', 'gml_id': 'no label', 'geom': 'no label', 'District': 'no label', 'LSGD': 'no label', 'Ward_Name': 'inline label - always visible', 'Ward_No': 'no label', 'Lsgd_Type': 'no label', 'Created_Da': 'no label', 'Surveyor': 'no label', 'Mob_No': 'no label', 'Remarks': 'no label', '_distLsgd': 'no label', 'OBJECTID': 'no label', '_result': 'no label', '_ulid': 'no label', '_distLsgd2': 'no label', 'Population': 'no label', });
lyr_LIESUREPOINTS_5.set('fieldLabels', {'fid': 'no label', 'full_id': 'no label', 'osm_id': 'no label', 'osm_type': 'no label', 'leisure': 'inline label - always visible', });
